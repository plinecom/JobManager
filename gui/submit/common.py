...
class CommonPanel(QtGui.QWidget):
    ...
    def init_ui(self):
        ...
        self.group_combo.addItems(self._jobList[0]._param["dispatcherInfo"][0].getparam()["groups"])
        ...
        self.pool_combo.addItems(self._jobList[0]._param["dispatcherInfo"][0].getparam()["pools"])
